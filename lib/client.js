...
var KNOWN_ERROR_CODES = /* @__PURE__ */ new Set(["rejected", "rate", "timeout", "upstream", "unconfigured", "internal"]);
...
function localizedErrorMessage(t, code) {
  switch (code) {
    case "rejected":
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-pe-overlay", onMouseDown: (event) => {
    ...
    "section",
    {
      ...
      children: [
        ...
        state.phase === "error" && state.error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-pe-error", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: state.error.localized ?? localizedErrorMessage(t, state.error.code) }),
          state.error.localized !== state.error.message && state.error.message !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-pe-error-detail", children: state.error.message })
        ] }),
